 <template>
   <div class="flash-deal py-16 px-5 product-swiper ">
     <div class="title">
       <h3 class="text-h3 mb-5 text-error font-weight-bold text-center  ">Flash Deals</h3>
     </div>
     <Swiper :pagination="{el:'.swiper-pagination' ,clickable:true}"
             ...
             :autoplay="{delay:3000}"
     >
       <SwiperSlide v-for="data in store.item" :key="data.id"
...
store.getProducts()
 ...
 const modeles=ref([Pagination,Navigation,Autoplay])
